...
const MobileChatLayout: FC<MobileChatLayoutProps> = ({ friends, session, sidebarOptions, unseenRequestCount }) => {
  ...
  // listen for path name changes to close the window
  ...
  return (
    <div className='fixed bg-lightprimary dark:bg-darkprimary border-b border-lightinteractive dark:border-darkinteractive top-0 inset-x-0 py-2 px-4'>
      <div className='w-full flex justify-between items-center'>
        <Link
          href='/dashboard'
          className={buttonVariants({ variant: 'ghost' })}>
          <Icons.Logo className='h-6 w-auto text-lightsecondary dark:text-darksecondary' />
        </Link>
                    ...
                    <div className='flex h-full flex-col overflow-hidden bg-lightprimary dark:bg-darkprimary py-6 shadow-xl'>
                      ...
                      <div className='relative mt-6 flex-1 px-4 sm:px-6'>
                        ...
                        <nav className='flex flex-1 flex-col'>
                          <ul
                            role='list'
                            className='flex flex-1 flex-col gap-y-7 text-lightinline dark:text-darkinline'>
                            <li>
                              <SidebarChatList
                                friends={friends}
